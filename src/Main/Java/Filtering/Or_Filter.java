...
public class Or_Filter{
	...
	public static void direct(Time_Filter tfilter, Position_Filter pfilter, ID_Filter ifilter) throws ParseException {
		...
		if((tfilter.getStart().equalsIgnoreCase("") && tfilter.getEnd().equalsIgnoreCase(""))) {
			...
			Or_Pos_And_ID(pfilter, ifilter);
		}
		else if(pfilter.getLat() == 0 && pfilter.getLon() == 0 && pfilter.getRadius() == 0) {

			Or_Time_And_ID(tfilter, ifilter);
		}
		
		else if(ifilter.getNameOfDevice().equalsIgnoreCase("")) {
			
			Or_Time_And_Pos(tfilter, pfilter);
		}
		
		else {
			
			Or_Time_And_Pos_And_ID(tfilter, pfilter, ifilter);
		}
	}
	
	
	public static void Or_Time_And_ID(Time_Filter tfilter, ID_Filter ifilter) throws ParseException {
	...
	public static void Or_Time_And_Pos(Time_Filter tfilter, Position_Filter pfilter) throws ParseException {
	...
	public static void Or_Pos_And_ID(Position_Filter pfilter, ID_Filter ifilter) {
	...
	public static void Or_Time_And_Pos_And_ID(Time_Filter tfilter, Position_Filter pfilter, ID_Filter ifilter) throws ParseException {
